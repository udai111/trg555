...
const FundamentalWidget = ({ symbol }: FundamentalWidgetProps) => {
  useEffect(() => {
    ...
    container.setAttribute(
      'data-get-url',
      `https://trendlyne.com/web-widget/fundamental-widget/Poppins/${symbol}/?posCol=00A25B&primaryCol=006AFF&negCol=EB3B00&neuCol=F7941E`
    );
  ...
  return <div id="fundamental-container" />;
};
