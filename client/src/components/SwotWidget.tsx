...
const SwotWidget = ({ symbol }: SwotWidgetProps) => {
  useEffect(() => {
    ...
    container.setAttribute(
      'data-get-url',
      `https://trendlyne.com/web-widget/swot-widget/Poppins/${symbol}/?posCol=00A25B&primaryCol=006AFF&negCol=EB3B00&neuCol=F7941E`
    );

    // Add container to DOM
    const parent = document.getElementById('swot-container');
    if (parent) {
